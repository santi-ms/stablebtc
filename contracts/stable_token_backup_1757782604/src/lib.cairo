...
pub mod StableToken {
    ...
    struct Storage {
        ...
        // address habilitada para mintear/burnear (VaultManager)
    ...
    fn mint(ref self: ContractState, to: ContractAddress, value: u256) {
        ...
        // Nota: omitimos Transfer(from=0,to=to) para evitar construir 0x0 como ContractAddress.
    }
...
fn set_minter(ref self: ContractState, new_minter: ContractAddress) {
    ...
    fn burn(ref self: ContractState, from: ContractAddress, value: u256) {
        ...
        // Nota: omitimos Transfer(from=from,to=0) por la misma razón.
    }
